            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo date('H:i:s  d-m-Y',strtotime($p['arsip_waktu_upload'])) ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <?php elseif ($status == 1) : ?>
                                ...
                                <button title="batal verifikasi dokumen" type="button" class="btn btn-danger" data-toggle="modal" data-target="#batalverifikasi_<?php echo $p['arsip_id']; ?>">
