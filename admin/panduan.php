        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="breadcome-list">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-heading"><h4 style="margin-bottom: 0px">Panduan</h4></div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel">
                <div class="panel-heading"><h3 class="panel-title">Silahkan Pilih Panduan Yang Anda Butuhkan</h3></div>
